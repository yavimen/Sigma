    ...
    class GiftBuilderBoys:GiftBuilder
    {
        public override void ChooseGreeting()
        {
            ...
            else
            {
                ...
                gift.Greeting = "Dear " + request.FullName + ". " + BoysGreetings.GetInstance()[random.Next(0, BoysGreetings.GetInstance().Lenght - 1)];
            }
        }
        ...
        public override void ChooseSweet()
        {
            ...
            {
                Random random = new Random();
                gift.Sweet = BoysSweets.GetInstance()[random.Next(0, BoysSweets.GetInstance().Lenght - 1)];
            }
        }
        ...
        public override void ChooseToys()
        {
            ...
            {
                Random random = new Random();
                gift.Toy = BoysToys.GetInstance()[random.Next(0, BoysToys.GetInstance().Lenght - 1)];
            }
        }
